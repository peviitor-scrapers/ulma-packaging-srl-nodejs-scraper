...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "ULMAPACKAGING") |
| group        | string   | Parent company group (if applicable) |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/peviitor-scrapers/ulma-packaging-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)